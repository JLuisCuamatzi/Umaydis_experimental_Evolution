...
echo 'Start the variant calling for 2021EE26'
...
input_cram_file="../02_MappingAndCoveragePlotting/bamFiles/2021EE26_BWA.mrkdup.addgp.cram" # File with aligment
output_mpileup_file="mpileupFiles/2021EE26_VC_bcftools.pileup"
output_vcf_file="vcfFiles/2021EE26_VC_bcftools.vcf.gz"
# create directories:
...
echo 'End the variant calling for 2021EE26'
#
