...
echo 'Start the checking the AF in 2021EE17'

bedFile="SNPCalling/Tables/SNPsToCheck.bed"

bamFile="../02_MappingAndCoveragePlotting/bamFiles/2021EE17_BWA.mrkdup.addgp.cram"

reference_genome="../USMA_Genome/USMA_521_v2/USMA_521_v2.fasta"

mkdir -p SNPCalling/Tables/Check_SNPs_AF
outputFile=SNPCalling/Tables/Check_SNPs_AF/2021EE17_SNPs_AlleleDepth.txt
...
echo 'End the checking SNPs AF in 2021EE17'
#
