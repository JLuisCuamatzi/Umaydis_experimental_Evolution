...
df.samples <- fread("~/Umaydis_experimental_Evolution/USMA_EE_Colonies_SampleSheet.csv")

# Read whole info of samples
df.experiment.info <- fread("~/Umaydis_experimental_Evolution/USMA_EE_Information.csv")
...
for (sample in df.samples$SampleID){
  setwd("~/Umaydis_experimental_Evolution/02_MappingAndCoveragePlotting/normalizedCoverageTables/")
