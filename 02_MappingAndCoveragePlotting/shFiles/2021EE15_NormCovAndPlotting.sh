...
echo 'Start to Compute Normalized Coverage for 2021EE15'
# Calculate normalized coverage with the following python script: ComputeMedianCoverage.py
FileDepthCoverage="coverageFiles/2021EE15_Q30.depth.gz"
FileNormalizedCoverage="normalizedCoverageTables/2021EE15_NormalizedCoverage.txt"
sample="2021EE15"
