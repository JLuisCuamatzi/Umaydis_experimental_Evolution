...
echo 'Start mapping for 2021EE47'

# Defining reference genome
reference_genome="../USMA_Genome/USMA_521_v2/USMA_521_v2.fasta"

# Defining inputs and outputs
fq_file_1="../01_Cleaning/fastqFiles/clean/2021EE47_R1_clean.fastq.gz"
fq_file_2="../01_Cleaning/fastqFiles/clean/2021EE47_R2_clean.fastq.gz"

bam_file="bamFiles/2021EE47_BWA.bam"

bam_mrkdup_file="bamFiles/2021EE47_BWA.mrkdup.bam"

dupMtrx_file="bamFiles/stats/2021EE47_BWA_DuplicateMatrix"

bam_mrkdup_addgp_file="bamFiles/2021EE47_BWA.mrkdup.addgp.bam"

cram_mrkdup_addgp_file="bamFiles/2021EE47_BWA.mrkdup.addgp.cram"

depth_file="coverageFiles/2021EE47_Q30.depth"

echo 'Running mapping with bwa mem for 2021EE47'
